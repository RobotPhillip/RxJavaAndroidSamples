...
public class RetrofitFragment extends Fragment {
    ...
    @BindView(R.id.demo_retrofit_contributors_with_user_info_username)
    EditText _username_info;

    @BindView(R.id.demo_retrofit_contributors_with_user_info_repository)
    EditText _repo_info;
    ...
    public void onListContributorsWithFullUserInfoClicked() {
        ...
        _disposables.add(
                _githubService
                        .contributors(_username_info.getText().toString(), _repo_info.getText().toString())
